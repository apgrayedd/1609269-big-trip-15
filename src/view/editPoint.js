...
const getEventFieldGroupPrice = (price) => `<div class="event__field-group  event__field-group--price">
...
//     console.log(offer)
//   });
//   const eventOffer = () => `<div class="event__offer-selector">
...
export const editPoint = ({type, price, offer}) => `<form class="event event--edit" action="#" method="post">
    <header class="event__header">
      ${getEventType(type)}
      ${getEventFieldGroupDestination(type)}
      ${getEventFieldGroupPrice(price)}
